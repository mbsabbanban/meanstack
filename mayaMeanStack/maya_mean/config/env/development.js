...
module.exports = {
  db: {
    uri: /* process.env.MONGOHQ_URL || process.env.MONGOLAB_URI || 'mongodb://' + (process.env.DB_1_PORT_27017_TCP_ADDR || 'localhost') + '/mean-dev' ||*/ 'mongodb://mbsabbanban:MS2569ms@ds021689.mlab.com:21689/sabban' ,
    options: {
      user: 'mbsabbanban',
      pass: 'MS2569ms'
    },
  ...
  facebook: {
    clientID: process.env.FACEBOOK_ID || '1674767872773927', // 'APP_ID',
    clientSecret: process.env.FACEBOOK_SECRET || '1ec887a574a0c5138db09de60344e112', // 'APP_SECRET',
